...
const STAGE_TEXTURES: Dictionary = {
    Stage.SMOLDERING: preload("res://assets/burning_stages/smoldering.svg"),
    Stage.KINDLING:   preload("res://assets/burning_stages/kindling.svg"),
    Stage.BLAZING:    preload("res://assets/burning_stages/blazing.svg"),
    Stage.FADING:     preload("res://assets/burning_stages/fading.svg"),
}
